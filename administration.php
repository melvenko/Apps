...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>GSIC Data Administration Tool</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="#">GSIC Data Administration Tool</a>
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              <a target="_blank" href="http://admin.goldensummitph.com/" class="navbar-link">admin.goldensummitph.com</a>
            </p>
            <ul class="nav">
              <li><a target="_blank" href="http://admin.goldensummitph.com/">Home</a></li>
              <li class="active"><a href="http://admin.goldensummitph.com/login-home.php">Create Event</a></li>
              <li><a target="_blank" href="http://gsicph.com/">GSICPH.COM</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
      ...
      <div class="row-fluid">
        <div class="span2">
			...
			<div class="alert alert-info" align="center" style="padding-bottom:20px">
		  	<span style="font-family:tahoma;color:red;font-size:13px"></span> Free Space for info <br /><br />
			<strong>
		  		<a style="padding:10px" class="btn-primary" target="_blank" href="http://www.gsicph.com/seminars-1/">Registration Page</a>
		  	</strong>
	        </div>
          ...
          <div class="row-fluid">
            <div class="span12">
				...
				<ul class="nav nav-tabs" id="grid-demo-tabs">
					<li class="active"><a href="#demo" data-toggle="tab">Data</a></li>
				...
				<div class="tab-content" id="grid-demo-tabs-content">
					...
					<div id="demo" class="tab-pane fade in active">
		        		...
		        		<a id="div_version" style="margin-left:9px; width:100px; font-family: tahoma; padding:5px; background-color: #117AC0; letter-spacing:1px; color: white; text-decoration:underline;" target="_blank" href="http://admin.goldensummitph.com/"></a>
						<br>
						</span>
					<iframe style="overflow:auto" onload="iframeLoaded(this)" name="demo_frame" frameborder="0" width="100%" height="500" src="demos/editing/db-table-grid.php"></iframe>
					</div>
		...
		<script>
			...
			jQuery('#code').load('index.php?file=/editing/db-table-grid.php');
